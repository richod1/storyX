...
const generate = async (queryDescription) => {
  const divinciModel = async (queryDescription) => {
    const response = await openaiClient.createCompletion({
      ...
      prompt: `Can you please generate a story of 100 lines for me based on the keyword \n\n${queryDescription}?
      I'd like to explore a world where this keyword holds immense power and see how it affects the characters and their journey. Feel free to be creative and surprise me with the plot and characters!`,
      max_tokens: 100,
      temperature: 0,
    });
